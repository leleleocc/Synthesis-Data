...
- Candidate id: `c5`
- Package slug: `tls-jemalloc-prefix`
...
- `environment/` is the sealed phase 03 base (`/synthesis/output/environment/`) merged with the phase 04 candidate overlay (`candidates/c5/environment/`); overlay files win on the same relative path.
