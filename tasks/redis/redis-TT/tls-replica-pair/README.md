...
- `environment/` is the sealed phase 03 base (`/synthesis/output/environment/`) merged with the phase 04 candidate overlay (`candidates/c2/environment/`); overlay files win on the same relative path.
