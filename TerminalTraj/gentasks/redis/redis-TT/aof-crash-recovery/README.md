...
- Candidate id: `c1`
- Package slug: `aof-crash-recovery`
...
- `environment/` is the sealed phase 03 base (`/synthesis/output/environment/`) merged with the phase 04 candidate overlay (`candidates/c1/environment/`); overlay files win on the same relative path.
