...
- Candidate id: c6
- Package slug: vocab-only-tok
- Source repo: https://github.com/ggml-org/llama.cpp
- Source commit: b29c606e28a01b1bc8c1351026a0fa6e616bf6c4

Provenance:

- `instruction.md` is a byte-for-byte copy of the phase 04 task (with any phase 05 review edits) from `candidates/c6/instruction.md`.
...
- `tests/` is a byte-for-byte copy of the phase 06 verifier tree after any phase 07 review edits from `candidates/c6/tests/`.
